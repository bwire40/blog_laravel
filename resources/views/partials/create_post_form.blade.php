    ...
    <div class="container mx-auto p-4">
        <form>
            <div class="space-y-12">
                <h1 class="text-5xl font-bold text-slate-600">Create Post</h1>
                <div class="border-b border-gray-900/10 pb-12">

                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            <label for="first-name" class="block   leading-6 text-gray-900 font-bold text-xl">Title</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-3">
                            <label for="last-name"
                                class="block   leading-6 text-gray-900 font-bold text-xl">Sub-title</label>
                            <div class="mt-2">
                    ...
                    <div class="col-span-full">
                        <label for="about" class="block   leading-6 text-gray-900 font-bold text-xl">Content</label>
                        <div class="mt-2">
                            <textarea id="about" name="about" rows="3"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 font-bold text-xl shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm: sm:leading-6"></textarea>
                        </div>
                        <p class="mt-3  leading-6 text-gray-600">Write a few sentences about your post.</p>
                    </div>
                </div>
